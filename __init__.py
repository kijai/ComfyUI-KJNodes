...
from .nodes.image_nodes import (
    ...
    RandomImageFromBatch, ImageBatchExtendWithOverlap, ImageBatchExtendWithOverlapList, 
...
NODE_CONFIG = {
    ...
    "ImageBatchExtendWithOverlapList": {"class": ImageBatchExtendWithOverlapList, "name": "Image Batch Extend With Overlap (List)"},
